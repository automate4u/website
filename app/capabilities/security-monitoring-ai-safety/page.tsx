...
` }} />
      <div dangerouslySetInnerHTML={{ __html: `<div class="hs-pro-scope" data-capability="security">
        ...
        <div class="hs-container">
            <div class="hs-head-grid">
                <div class="hs-head-content">
                    <h1 id="hs-head-title" class="hs-h1">Security, Monitoring & AI Safety</h1>
                    <p class="hs-lead">
                        Secure, monitored, and controlled AI — by design.
                        We build AI and automation systems with security, governance, and observability
                        built in from day one, not bolted on later.
                    </p>
                    <ul class="hs-meta-list" aria-label="What we secure">
                        <li>AI Security</li>
                        <li>AI Observer</li>
        ...
        <div class="hs-container">
            ...
            <div class="hs-columns">
                <article class="hs-panel">
                    <h3 class="hs-h3">AI risk concerns</h3>
                    <ul class="hs-list">
                        <li>Fear of autonomous systems making unauthorized changes.</li>
                        <li>Concerns about AI "going rogue" or accessing wrong data.</li>
                        <li>Lack of visibility into what AI agents are doing.</li>
                    </ul>
                </article>

                <article class="hs-panel">
                    <h3 class="hs-h3">Security & compliance</h3>
                    <ul class="hs-list">
                        <li>Data exposure and access control concerns.</li>
                        <li>Regulatory and industry compliance requirements.</li>
                        <li>Need for audit trails and logging.</li>
                    </ul>
                </article>

                <article class="hs-panel">
                    <h3 class="hs-h3">Monitoring gaps</h3>
                    <ul class="hs-list">
                        <li>No real-time monitoring of AI behavior.</li>
                        <li>Inability to block or flag problematic actions.</li>
                        <li>No incident response plan for AI systems.</li>
                    </ul>
                </article>
            </div>
        </div>
    ...
    <section class="hs-capabilities" aria-labelledby="hs-cap-title">
        <div class="hs-container">
            <h2 id="hs-cap-title" class="hs-h2">How we secure AI</h2>
            ...
            <div class="hs-cap-accordion">
                <details class="hs-cap-detail">
                    <summary class="hs-cap-summary">
                        ...
                        <span class="hs-cap-title">AI Security & Cybersecurity</span>
                    </summary>
                    <div class="hs-cap-content">
                        <p class="hs-p">AI-driven cybersecurity capabilities with intelligent, customizable system monitoring and anomaly detection.</p>
                        <ul class="hs-bullets">
                            <li>Anomaly detection around AI behavior and workflows</li>
                            <li>Intelligent threat monitoring and response</li>
                            <li>Security-first architecture and design</li>
                        </ul>
                    </div>
                </details>
                ...
                <details class="hs-cap-detail">
                    <summary class="hs-cap-summary">
                        <span class="hs-cap-icon" aria-hidden="true"></span>
                        <span class="hs-cap-title">AI Observer</span>
                    </summary>
                    <div class="hs-cap-content">
                        <p class="hs-p">Monitor AI agents and automated systems in real time, enforce rules, and block actions outside of policy.</p>
                        <ul class="hs-bullets">
                            <li>Real-time monitoring of AI agent actions</li>
                            <li>Policy enforcement and guardrails</li>
                            <li>Automatic blocking or flagging of violations</li>
                        </ul>
                    </div>
                </details>
                ...
                <details class="hs-cap-detail">
                    <summary class="hs-cap-summary">
                        <span class="hs-cap-icon" aria-hidden="true"></span>
                        <span class="hs-cap-title">Governance & Guardrails</span>
                    </summary>
                    <div class="hs-cap-content">
                        <p class="hs-p">Role-based access, permission design, data access policies, and audit trails for AI decisions.</p>
                        <ul class="hs-bullets">
                            <li>Role-based access control (RBAC) for AI systems</li>
                            <li>Data access policies and permission boundaries</li>
                ...
                <details class="hs-cap-detail">
                    <summary class="hs-cap-summary">
                        <span class="hs-cap-icon" aria-hidden="true"></span>
                        <span class="hs-cap-title">Compliance Alignment</span>
                    </summary>
                    <div class="hs-cap-content">
                        <p class="hs-p">Work with internal security and compliance teams to ensure AI deployments respect industry and regulatory constraints.</p>
                        <ul class="hs-bullets">
                            <li>HIPAA, SOC 2, GDPR, and industry-specific compliance</li>
                            <li>Documentation and evidence for audits</li>
    ...
    <section class="hs-cases" aria-labelledby="hs-cases-title">
        <div class="hs-container">
            <h2 id="hs-cases-title" class="hs-h2">Example scenarios</h2>

            <div class="hs-case-grid">
                <article class="hs-case">
                    <h3 class="hs-h4">Prevented Data Exposure</h3>
                    <ul class="hs-list">
                        <li>AI Observer detected agent accessing restricted data</li>
                        <li>Action blocked before execution</li>
                        <li>Security team alerted with full context</li>
                    </ul>
                </article>

                <article class="hs-case">
                    <h3 class="hs-h4">Compliant Healthcare Deployment</h3>
                    <ul class="hs-list">
                        <li>HIPAA-compliant AI voice agent for appointment booking</li>
                        <li>PHI access controls and audit logging</li>
                        <li>Passed security review on first submission</li>
                    </ul>
                </article>

                <article class="hs-case">
                    <h3 class="hs-h4">Financial Services Guardrails</h3>
                    <ul class="hs-list">
                        <li>AI agents limited to read-only access initially</li>
                        <li>Phased rollout with increasing permissions</li>
    ...
    <section id="hs-contact" class="hs-contact" aria-labelledby="hs-contact-title">
        <div class="hs-container">
            <h2 id="hs-contact-title" class="hs-h2">Talk to us about secure AI deployments</h2>
            ...
            <form class="hs-form" action="https://formspree.io/f/xzzjvgkw" method="post">
                <div class="hs-form-grid">
                    ...
                    <label class="hs-field hs-field--full">
                        <span class="hs-label">What are your security concerns?</span>
                        <textarea name="focus" rows="4"
                            placeholder="e.g., AI accessing sensitive data; compliance requirements; monitoring AI behavior; audit trails"></textarea>
                    </label>
                    <input type="hidden" name="capability" value="Security, Monitoring & AI Safety">
                </div>
    ...
    <section class="hs-foot" aria-hidden="true">
        <div class="hs-container">
            <span class="hs-mark">
                ...
                Automate4U — Security, Monitoring & AI Safety
            </span>
        </div>
    </section>
</div>
