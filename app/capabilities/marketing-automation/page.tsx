...
export const metadata: Metadata = {
    title: 'AI Marketing Automation & Strategy | Automate4U',
    description: 'Scale your outreach with AI-powered marketing engines. We build CRM automations, lead scoring systems, and generative AI content workflows that drive revenue.',
};
...
` }} />
            <div dangerouslySetInnerHTML={{
                __html: `<div class="hs-pro-scope" data-capability="marketing-automation">
        ...
        <div class="hs-container">
            <div class="hs-head-grid">
                <div class="hs-head-content">
                    <h1 id="hs-head-title" class="hs-h1">Marketing Automation & Strategy</h1>
                    <p class="hs-lead">
                        Scale your outreach without scaling your headcount.
                        We build AI-powered marketing engines that identify, nurture, and convert leads
                        automatically using smart segmentation and personalized content.
                    </p>
                ...
                <div class="hs-head-image">
                    <img src="/images/capabilities/marketing_automation.png"
                        alt="Marketing automation strategy board" />
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="hs-container">
            ...
            <div class="hs-columns">
                <article class="hs-panel">
                    <h3 class="hs-h3">Leaky Funnels</h3>
                    <ul class="hs-list">
                        <li>Leads falling through the cracks.</li>
                        <li>Inconsistent follow-up speed.</li>
                        <li>No visibility into where prospects drop off.</li>
                    </ul>
                </article>

                <article class="hs-panel">
                    <h3 class="hs-h3">Manual Campaign Work</h3>
                    <ul class="hs-list">
                        <li>Hours spent formatting emails.</li>
                        <li>Manual list cleaning and segmentation.</li>
                        <li>Copy-pasting data between marketing & sales tools.</li>
                    </ul>
                </article>

                <article class="hs-panel">
                    <h3 class="hs-h3">Generic Messaging</h3>
                    <ul class="hs-list">
                        <li>"Spray and pray" email blasts.</li>
                        <li>Low engagement due to irrelevant content.</li>
                        <li>Inability to personalize at scale.</li>
                    </ul>
                </article>
            </div>
        </div>
            ...
            <div class="hs-cap-accordion">
                <details class="hs-cap-detail">
                    <summary class="hs-cap-summary">
                        ...
                        <span class="hs-cap-title">CRM & Hubspot Optimization</span>
                    </summary>
                    <div class="hs-cap-content">
                        <p class="hs-p">We turn your CRM into an active revenue engine, not just a database.</p>
                        <ul class="hs-bullets">
                            <li>Advanced property logic and data hygiene automations</li>
                            <li>Integration with ad platforms and sales tools</li>
                            <li>Deal pipeline automation and alerts</li>
                        </ul>
                    </div>
                </details>
                ...
                <details class="hs-cap-detail">
                    <summary class="hs-cap-summary">
                        <span class="hs-cap-icon" aria-hidden="true"></span>
                        <span class="hs-cap-title">AI Content & Nurture Engines</span>
                    </summary>
                    <div class="hs-cap-content">
                        <p class="hs-p">Systems that generate and assemble personalized content based on lead behavior.</p>
                        <ul class="hs-bullets">
                            <li>Dynamic newsletter assembly using AI</li>
                            <li>Personalized outreach sequences based on viewing history</li>
                            <li>Automated case study matching for prospects</li>
                        </ul>
                    </div>
                </details>
                ...
                <details class="hs-cap-detail">
                    <summary class="hs-cap-summary">
                        <span class="hs-cap-icon" aria-hidden="true"></span>
                        <span class="hs-cap-title">AI Creative & Production</span>
                    </summary>
                    <div class="hs-cap-content">
                        <p class="hs-p">Scale your asset production with Generative AI tools integrated into your workflow.</p>
                        <ul class="hs-bullets">
                            <li>AI video generation and editing at scale</li>
                            <li>Image generation for social & ads (Midjourney/DALL-E)</li>
                            <li>Automated captioning and translation</li>
                        </ul>
                    </div>
                </details>
                ...
                <details class="hs-cap-detail">
                    <summary class="hs-cap-summary">
                        <span class="hs-cap-icon" aria-hidden="true"></span>
                        <span class="hs-cap-title">Social & Ad Automation</span>
                    </summary>
                    <div class="hs-cap-content">
                        <p class="hs-p">Manage paid and organic channels with intelligent automation rules.</p>
                        <ul class="hs-bullets">
                            <li>Automated posting and scheduling across platforms</li>
                            <li>Ad budget alerts and bid management sync</li>
                            <li>Cross-channel performance aggregation</li>
                        </ul>
                    </div>
                </details>
                ...
                <details class="hs-cap-detail">
                    <summary class="hs-cap-summary">
                        <span class="hs-cap-icon" aria-hidden="true"></span>
                        <span class="hs-cap-title">Smart Lead Routing</span>
                    </summary>
                    <div class="hs-cap-content">
                        <p class="hs-p">Ensure the right leads get to the right people (or agents) instantly.</p>
                        <ul class="hs-bullets">
                            <li>Automated qualification workflows</li>
                            <li>Round-robin routing based on capacity and expertise</li>
                            <li>Instant calendar booking integration</li>
                        </ul>
                    </div>
                </details>
                ...
                <details class="hs-cap-detail">
                    <summary class="hs-cap-summary">
                        <span class="hs-cap-icon" aria-hidden="true"></span>
                        <span class="hs-cap-title">Attribution & Reporting</span>
                    </summary>
                    <div class="hs-cap-content">
                        <p class="hs-p">Clear visibility into what marketing efforts are actually driving revenue.</p>
                        <ul class="hs-bullets">
                            <li>Multi-touch attribution models</li>
                            <li>Automated weekly performance dashboards</li>
                            <li>ROI tracking by campaign and channel</li>
                        </ul>
                    </div>
                </details>
            </div>
    ...
    <section class="hs-cases" aria-labelledby="hs-cases-title">
        <div class="hs-container">
            <h2 id="hs-cases-title" class="hs-h2">Example workflows</h2>

            <div class="hs-case-grid">
                <article class="hs-case">
                    <h3 class="hs-h4">Webinar -> Nurture Machine</h3>
                    <ul class="hs-list">
                        <li>Auto-register from LinkedIn forms</li>
                        <li>Send reminders & unique join links</li>
                        <li>A/B test follow-ups based on attendance time</li>
                    </ul>
                </article>

                <article class="hs-case">
                    <h3 class="hs-h4">Inbound Lead Fast-Lane</h3>
                    <ul class="hs-list">
                        <li>Enrich lead data (Clearbit/ZoomInfo) automatically</li>
                        <li>Score lead intent in real-time</li>
                        <li>Instant Slack alert to sales for high-value prospects</li>
                    </ul>
                </article>

                <article class="hs-case">
                    <h3 class="hs-h4">Customer Onboarding</h3>
                    <ul class="hs-list">
                        <li>Trigger welcome sequence upon contract sign</li>
                        <li>Drip feed educational content and tutorials</li>
                        <li>Check-in alerts for CSMs if usage is low</li>
                    </ul>
                </article>
                <article class="hs-case">
                    <h3 class="hs-h4">Social Content Machine</h3>
                    <ul class="hs-list">
                        <li>Turn 1 video into 10 social clips automatically</li>
                        <li>Generate captions and hashtags for each platform</li>
                        <li>Auto-schedule to LinkedIn, Twitter, and Instagram</li>
                    </ul>
                </article>
            </div>
        </div>
    ...
    <section id="hs-contact" class="hs-contact" aria-labelledby="hs-contact-title">
        <div class="hs-container">
            <h2 id="hs-contact-title" class="hs-h2">Boost your marketing ROI</h2>
            ...
            <form class="hs-form" action="https://formspree.io/f/xzzjvgkw" method="post">
                <div class="hs-form-grid">
                    ...
                    <label class="hs-field hs-field--full">
                        <span class="hs-label">What's your biggest marketing funnel bottleneck?</span>
                        <textarea name="focus" rows="4"
                            placeholder="e.g., Lead quality; slow response time; manual reporting; content production"></textarea>
                    </label>
                    <input type="hidden" name="capability" value="Marketing Automation & Strategy">
                </div>
                <div class="hs-actions">
                    <button class="hs-btn hs-primary" type="submit">
                        Submit
                    </button>
                    <p class="hs-small">We'll help you audit your current stack.</p>
                </div>
            </form>
        </div>
    </section>
    ...
    <section class="hs-foot" aria-hidden="true">
        <div class="hs-container">
            <span class="hs-mark">
                ...
                Automate4U — Marketing Automation & Strategy
            </span>
        </div>
    </section>
</div>
