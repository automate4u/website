...
const frictionAreas = [
  ...
  { title: "Staff lose focus to repeatable admin", text: "Teams answer the same questions, chase missing details, route messages, schedule tours, confirm absences, and document exceptions throughout the day." },
];
...
const systemGroups = [
  ...
  { title: "Operations data", items: ["Calendar", "Enrollment CRM", "Classroom platform", "Program availability", "Policy documents"] },
  { title: "Team workflow", items: ["Admissions tasks", "Staff handoff", "Parent follow-up", "Audit log", "KPI reporting"] },
];
...
export default function EducationChildcarePage() {
  return (
    <IndustryAcceleratorPage
      ...
      title="AI operations support for families, learners, enrollment, and admin workflows."
      description="We help childcare centers, private schools, tutoring programs, youth education providers, and enrollment-driven learning organizations reduce routine communication work while keeping sensitive decisions under staff control."
      ...
      valueDescription="The first useful automation is usually a frequent, structured workflow where better intake, faster routing, and clear escalation can reduce staff interruptions without weakening trust."
      ...
      sectorTitle="Communication expectations are rising while staff attention remains limited."
      sectorDescription="The useful shift is not replacing staff. It is giving teams a reliable support layer for intake, routing, follow-up, and escalation."
      sectorShifts={sectorShifts}
      systemsTitle="Automation should fit the tools and channels your team already uses."
      systemsDescription="The first workflow can connect communication intake to calendars, enrollment tools, classroom platforms, CRM records, staff notifications, and reporting."
      ...
      rollout={rollout}
      confidenceTitle="The first project should be specific enough to price, test, and trust."
      confidenceDescription="We recommend starting with a defined communication workflow before expanding into more channels, more locations, or more sensitive scenarios."
