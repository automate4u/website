...
const presentationBySlug: Record<string, ServicePresentation> = {
  ...
  "ai-transformation": {
    ...
    scenario: {
      ...
      text: "Strategy work should create a ranked first move, a practical budget range, and a decision path, not a vague transformation deck.",
      signals: ["Workflow inventory", "Value and risk ranking", "Paid next step", "30/60/90-day measurement"],
    },
    pilotProof: [
      ...
      { label: "Scope", title: "Paid next step", text: "Define whether the right follow-on is a paid blueprint, pilot, build sprint, operational cleanup, or no-build recommendation." },
      { label: "Measure", title: "Value case", text: "Tie the initiative to response time, cycle time, labor hours, conversion, cost per request, escalation rate, or follow-up completion." },
    ],
    sections: {
      workflowTitle: "Strategy should turn AI interest into specific pilot decisions.",
      workflowDescription: "The output should identify the workflow, budget drivers, controls, systems, staff roles, approval points, and value metrics behind the first useful build.",
      ...
      rolloutDescription: "The path should make spend easier to approve by tying the next step to risk, value, measurable outcomes, and the decision after the pilot.",
  ...
  "marketing-automation": {
    ...
    scenario: {
      ...
      text: "Marketing automation works best when AI speeds up drafting, approval, CRM follow-up, and reporting while people keep control of brand and claims.",
      signals: ["Content calendar backlog", "Approval queue", "Lead nurture", "CRM follow-up"],
    },
    pilotProof: [
      ...
      { label: "Follow", title: "Lead movement", text: "Connect content and campaigns to CRM follow-up, nurture paths, reply tracking, and reporting." },
    ],
    sections: {
      workflowTitle: "Marketing agents should create approved output, not random content volume.",
      workflowDescription: "The useful workflow turns approved source material into drafts, routes review, schedules approved work, triggers follow-up, and reports what happened.",
      systemsTitle: "Marketing automation should connect content, CRM, and reporting.",
      systemsDescription: "We connect the creative workflow to the places where campaigns are planned, approved, published, measured, and followed up in the CRM.",
